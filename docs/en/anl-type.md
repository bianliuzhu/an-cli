...
| swaggerConfig[].timeout                              | number                                                                          | No       | Timeout for fetching Swagger JSON data (in milliseconds), defaults to `15000` (15 seconds). If not set, uses global `timeout` configuration                                                                                                                                                                                                                                                                       |
...
| timeout                                              | number                                                                          | No       | Global timeout for fetching Swagger JSON data (in milliseconds), defaults to `15000` (15 seconds). Each server can override individually                                                                                                                                                                                                                                                                          |
